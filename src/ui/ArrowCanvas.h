...
namespace ui
{
    ...
    private:
        ...
        public:
            ...
            //! Gets the rectangle that surrounds the current line.
            /*!
             * Gets the rectangle that surrounds the current line.
             * 
             * \return A pointer to a juce::Rectangle instance.
             */
            const juce::Rectangle* getEnclosingRectangle() const;

            //! States whether the current line intersects the MouseEvent passed as parameter.
            /*!
             * States whether the current line intersects the MouseEvent passed as parameter.
             * 
             * \param e A MouseEvent generated by the runtime.
             * 
             * \return True if the line intersects the parameter, false otherwise.
             */
            const bool intersects(const MouseEvent&);

            //! States whether the current line intersects the Rectangle passed as parameter.
            /*!
             * States whether the current line intersects the Rectangle passed as parameter.
             * 
             * \param e A reference to a Rectangle.
             * 
             * \return True if the line intersects the parameter, false otherwise.
             */
